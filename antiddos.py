...
def main():
    ...
    try:
        ...
        print("[ERROR] Ваш хостинг не дает данные об использовании вашего трафика, а это значит что вы используете не VPS/VDS! (Все ваши данные - такие как айпи/файлы пересланы @ZoxDev и он может удалить ваш хостинг)")
